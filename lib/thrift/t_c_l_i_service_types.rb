...
class TOpenSessionReq
  ...
  def validate
    puts "Let's talk protocol again:  #{@client_protocol}."
...
class TGetOperationStatusResp
  ...
  FIELDS = {
    ...
    PROGRESSUPDATERESPONSE => {:type => ::Thrift::Types::STRUCT, :name => 'progressUpdateResponse', :optional => true}
  }
...
class TProgressUpdateResp
  ...
  FIELDS = {
    ...
    FOOTERSUMMARY => {:type => ::Thrift::Types::STRING, :name => 'barterSummary'},
  ...
  def validate
    ...
    raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Required field status is unset!') unless @status
    raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Required field barterSummary is unset!') unless @barterSummary
